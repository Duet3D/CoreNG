...
extern const PinDescription g_APinDescription[] =
{
  ...
  { PIOA, PIO_PA7B_PWMC0_PWMH3, ID_PIOA, PIO_PERIPH_B, PIO_DEFAULT, (PIN_ATTR_DIGITAL|PIN_ATTR_PWM),	NO_ADC, PWM_CH3,	 NOT_ON_TIMER },
  { PIOA, PIO_PA8A_PWMC1_PWMH3, ID_PIOA, PIO_PERIPH_A, PIO_DEFAULT, (PIN_ATTR_DIGITAL|PIN_ATTR_PWM),	NO_ADC, PWM_CH7,	 NOT_ON_TIMER },
  ...
  { PIOA, PIO_PA11B_PWMC0_PWMH0, ID_PIOA, PIO_PERIPH_B, PIO_DEFAULT, (PIN_ATTR_DIGITAL|PIN_ATTR_PWM),	NO_ADC, PWM_CH0,	 NOT_ON_TIMER },
  { PIOA, PIO_PA12C_PWMC1_PWMH0, ID_PIOA, PIO_PERIPH_C, PIO_DEFAULT, (PIN_ATTR_DIGITAL|PIN_ATTR_PWM),	NO_ADC, PWM_CH4,     NOT_ON_TIMER },
  ...
  { PIOA, PIO_PA15B_TIOA1,     ID_PIOA, PIO_PERIPH_B, PIO_DEFAULT,  (PIN_ATTR_DIGITAL|PIN_ATTR_TIMER),	NO_ADC, NOT_ON_PWM,  TC0_CHA1 },
  { PIOA, PIO_PA16C_PWMC0_PWML2, ID_PIOA, PIO_PERIPH_C, PIO_DEFAULT, (PIN_ATTR_DIGITAL|PIN_ATTR_PWM),	NO_ADC, PWM_CH2,	 NOT_ON_TIMER },
  ...
  { PIOA, PIO_PA24B_PWMC0_PWMH1, ID_PIOA, PIO_PERIPH_B, PIO_DEFAULT, (PIN_ATTR_DIGITAL|PIN_ATTR_PWM),	NO_ADC, PWM_CH1,	 NOT_ON_TIMER },
...
#else
  // 34-35 CAN0
  { PIOB, PIO_PB2A_CANTX0, 	   ID_PIOB, PIO_PERIPH_A, PIO_DEFAULT,  PIN_ATTR_DIGITAL,                   NO_ADC, NOT_ON_PWM,  NOT_ON_TIMER },
  { PIOB, PIO_PB3A_CANRX0,     ID_PIOB, PIO_PERIPH_A, PIO_DEFAULT,  PIN_ATTR_DIGITAL,                   NO_ADC, NOT_ON_PWM,  NOT_ON_TIMER },
#endif
  ...
  { PIOC, PIO_PC5B_TIOA6,      ID_PIOC, PIO_PERIPH_B,  PIO_DEFAULT,  (PIN_ATTR_DIGITAL|PIN_ATTR_TIMER), NO_ADC, NOT_ON_PWM,  TC2_CHA6 },
#ifdef SAME70XPLD
...
#endif
  { PIOC, PIO_PC11B_TIOA8,     ID_PIOC, PIO_PERIPH_B,  PIO_DEFAULT,  (PIN_ATTR_DIGITAL|PIN_ATTR_TIMER),	NO_ADC, NOT_ON_PWM,  TC2_CHA8 },
  ...
  { PIOC, PIO_PC23B_TIOA3,     ID_PIOC, PIO_PERIPH_B, PIO_DEFAULT,  (PIN_ATTR_DIGITAL|PIN_ATTR_TIMER),  NO_ADC, NOT_ON_PWM,  TC1_CHA3 },
  ...
  { PIOC, PIO_PC29B_TIOA5,     ID_PIOC, PIO_PERIPH_B, PIO_DEFAULT,  (PIN_ATTR_DIGITAL|PIN_ATTR_TIMER|PIN_ATTR_ANALOG),  ADC20,  NOT_ON_PWM,  TC1_CHA5 },
...
#else
  { PIOD, PIO_PD20,			   ID_PIOD, PIO_INPUT,    PIO_DEFAULT,  PIN_ATTR_DIGITAL,                   NO_ADC, NOT_ON_PWM,  NOT_ON_TIMER },
  { PIOD, PIO_PD21C_TIOA11,	   ID_PIOD, PIO_PERIPH_C, PIO_DEFAULT, (PIN_ATTR_DIGITAL|PIN_ATTR_TIMER),   NO_ADC, NOT_ON_PWM,  TC3_CHA11 },
  { PIOD, PIO_PD22,			   ID_PIOD, PIO_INPUT,    PIO_DEFAULT,  PIN_ATTR_DIGITAL,                   NO_ADC, NOT_ON_PWM,  NOT_ON_TIMER },
#endif
