...
extern const PinDescription g_APinDescription[] =
{
  ...
  // PA3-4 are connected to EEPROM (XPLD) (TWI0)
  ...
  // 27-28
  // PC8 is connected to USER LED on XPLD (active low)
  ...
  // PC11 is connected to EEPROM (XPLD)
  ...
  // 32
  { PIOC, PIO_PC16,            ID_PIOC, PIO_OUTPUT_0, PIO_DEFAULT,  PIN_ATTR_DIGITAL,                   NO_ADC, NOT_ON_PWM,  NOT_ON_TIMER },	// HSMCI CD (XPLD)
