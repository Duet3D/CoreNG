...
// HSMCI
static const uint8_t APIN_HSMCI_CLOCK = 102;
static const uint8_t APINS_HSMCI_DATA = 103;

static const uint32_t MaxPinNumber = 101;						// last GPIO pin
